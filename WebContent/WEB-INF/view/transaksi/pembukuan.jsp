              ...
              <div class="card card-stats mb-4 mb-xl-0">
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <h5 class="card-title text-uppercase text-muted mb-0">Income Value</h5>
                      <span class="h2 font-weight-bold mb-0">Rp ${jumlahPemJan}</span>
                    </div>
                    <div class="col-auto">
                      <div class="icon icon-shape bg-danger text-white rounded-circle shadow">
                        <i class="fas fa-chart-bar"></i>
              ...
              <div class="card card-stats mb-4 mb-xl-0">
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <h5 class="card-title text-uppercase text-muted mb-0">Expense Value</h5>
                      <span class="h2 font-weight-bold mb-0">Rp ${jumlahNotJan}</span>
                    </div>
                    <div class="col-auto">
                      <div class="icon icon-shape bg-warning text-white rounded-circle shadow">
                        <i class="fas fa-chart-pie"></i>
              ...
              <div class="card card-stats mb-4 mb-xl-0">
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <h5 class="card-title text-uppercase text-muted mb-0">Profit output</h5>
                      <span class="h2 font-weight-bold mb-0">Rp ${jumlahJan}</span>
                    </div>
                    <div class="col-auto">
                      <div class="icon icon-shape bg-yellow text-white rounded-circle shadow">
                        <i class="fas fa-users"></i>
          ...
          <div class="card shadow">
            ...
            <div class="table-responsive">
              ...
              <table class="table align-items-center table-flush">
                ...
                <tbody>
                  <tr>
                    <th scope="row">${pemasukanJan.id} </th>
                    <td>Rp ${pemasukanJan.total}</td>
                    <td>${pemasukanJan.dari}</td>
                    <td>${pemasukanJan.catatan}</td>
                  </tr>
                </tbody>
                </c:forEach>
              </table>
          ...
          <div class="card shadow">
            ...
            <div class="table-responsive">
              ...
              <table class="table align-items-center table-flush">
                ...
                <tbody>
                  <tr>
                    <th scope="row">${notaJan.nid} </th>
                    <td>${notaJan.nkeperluan}</td>
                    <td>${notaJan.nnama}</td>
                    <td>Rp ${notaJan.nharga}</td>
                    <td>${notaJan.ncatatan}</td>
                  </tr>
                </tbody>
                </c:forEach>
              </table>
              ...
              <div class="card card-stats mb-4 mb-xl-0">
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <h5 class="card-title text-uppercase text-muted mb-0">Income Value</h5>
                      <span class="h2 font-weight-bold mb-0">Rp ${jumlahPemFeb}</span>
                    </div>
                    <div class="col-auto">
                      <div class="icon icon-shape bg-danger text-white rounded-circle shadow">
                        <i class="fas fa-chart-bar"></i>
              ...
              <div class="card card-stats mb-4 mb-xl-0">
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <h5 class="card-title text-uppercase text-muted mb-0">Expense Value</h5>
                      <span class="h2 font-weight-bold mb-0">Rp ${jumlahNotFeb}</span>
                    </div>
                    <div class="col-auto">
                      <div class="icon icon-shape bg-warning text-white rounded-circle shadow">
                        <i class="fas fa-chart-pie"></i>
              ...
              <div class="card card-stats mb-4 mb-xl-0">
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <h5 class="card-title text-uppercase text-muted mb-0">Profit output</h5>
                      <span class="h2 font-weight-bold mb-0">Rp ${jumlahFeb}</span>
                    </div>
                    <div class="col-auto">
                      <div class="icon icon-shape bg-yellow text-white rounded-circle shadow">
                        <i class="fas fa-users"></i>
          ...
          <div class="card shadow">
            ...
            <div class="table-responsive">
              ...
              <table class="table align-items-center table-flush">
                ...
                <tbody>
                  <tr>
                    <th scope="row">${pemasukanFeb.id} </th>
                    <td>Rp ${pemasukanFeb.total}</td>
                    <td>${pemasukanFeb.dari}</td>
                    <td>${pemasukanFeb.catatan}</td>
                  </tr>
                </tbody>
                </c:forEach>
              </table>
          ...
          <div class="card shadow">
            ...
            <div class="table-responsive">
              ...
              <table class="table align-items-center table-flush">
                ...
                <tbody>
                  <tr>
                    <th scope="row">${notaFeb.nid} </th>
                    <td>${notaFeb.nkeperluan}</td>
                    <td>${notaFeb.nnama}</td>
                    <td>Rp ${notaFeb.nharga}</td>
                    <td>${notaFeb.ncatatan}</td>
                  </tr>
                </tbody>
                </c:forEach>
              </table>
