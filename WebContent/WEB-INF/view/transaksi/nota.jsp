		        ...
		        <div class="col">
		            ...
		            <div class="nav-wrapper">
					    <ul class="nav nav-pills nav-fill flex-column flex-md-row" id="tabs-icons-text" role="tablist">
					        <li class="nav-item">
					            <a class="nav-link mb-sm-3 mb-md-0 active" background-color="#5e72e4" id="tabs-icons-text-1-tab"  href="showFormForAdd" role="tab" aria-controls="tabs-icons-text-1" aria-selected="false"><i class="ni ni-cloud-upload-96 mr-2"></i>Income</a>
					        </li>
					        <li class="nav-item">
					            <a class="nav-link mb-sm-3 mb-md-0" background-color="#fff"  id="tabs-icons-text-2-tab"  href="#tabs-icons-text-2" role="tab"  aria-controls="tabs-icons-text-2" aria-selected="true"><i class="ni ni-bell-55 mr-2"></i>Outcome</a>
					        </li>
