		        ...
		        <div class="col">
		            ...
		            <div class="nav-wrapper">
					    <ul class="nav nav-pills nav-fill flex-column flex-md-row" id="tabs-icons-text" role="tablist">
					        <li class="nav-item">
					            <a class="nav-link mb-sm-3 mb-md-0 active" id="tabs-icons-text-1-tab"  href="showFormForAdd" role="tab" aria-controls="tabs-icons-text-1" aria-selected="false"><i class="ni ni-cloud-upload-96 mr-2"></i>Income</a>
					        </li>
					        <li class="nav-item">
